...
import { createTablePraticEducationValues } from '@/backend/migrations'

export async function GET() {
  const query = 'SELECT * FROM pratic_education'
  try {
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    await createTablePraticEducationValues(attributeFields)
